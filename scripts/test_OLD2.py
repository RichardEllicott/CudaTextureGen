...
def test_resample():
    ...
    noise = get_fractal_noise(width=1024, height=1024, octaves=3,
                              base_period=7, base_seed=0, gain=0.8, lacunarity=1.9)
...
# we have a bug with these shader maps test
def test_shader_maps2(width=1024, height=1024):
    ...
    save_array_as_image(
        normal_map * 255, "output/{}.normal.png".format(filename_base))
