...
REFACTOR TO NEW DEVICE ARRAY PATTERN
...
class Animation:
    ...
    def save_mpeg(self, filename):
        with imageio.get_writer(filename, fps=self.fps, codec=self.codec) as writer:
            for frame in self._frames:
                writer.append_data(frame)


def test_erosion7_animation(map_width=512, map_height=512, filename_base="erosion7_animation"):
