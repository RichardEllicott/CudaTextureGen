...
// fast 1/sqrt(x)
DH_INLINE float rsqrtf(float x) {
#ifdef ENABLE_FAST_MATH
...
DH_INLINE float fmaf(float a, float b, float c) {
#ifdef ENABLE_FAST_MATH
...
// fast sine and cos
DH_INLINE void sincosf(float x, float *sin, float *cos) {
#ifdef ENABLE_FAST_MATH
